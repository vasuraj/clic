...
$selected_agri_soils=$this->uri->segment(4);

?>

<a  href='<?php echo base_url();?>index.php/agri/insert_agri_verities/<?php echo $selected_agri; ?>' class="btn btn-warning" >Insert Into Verities</a>
</div>
...
echo form_open('agri/store_agri_soils/'.$selected_agri,array('class'=>'form','enctype'=>'multipart/form-data'));
echo "<table>";




echo '<tr><td><span class="row">
...
echo '<textarea name="text" id="content_2" ><p>'.$selected_agri_soils.'</p></textarea>';
...
?>
 <input type='submit' class="btn btn-primary" value='save in soils'/>
<?php
