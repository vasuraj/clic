...
$selected_npm=$this->uri->segment(3);
if($selected_npm!='' || $selected_npm!=null)
{
$selected_npm_info=$this->model_npm->get_npm($selected_npm);


foreach ($selected_npm_info as $value) {
	


	 	$this->$npm_id =$value->npm_id;
...
$final_category='Soil_improve';


echo form_open('npm/store_npm/'.$selected_npm,array('class'=>'form','enctype'=>'multipart/form-data'));
echo "<h4>NPM</h4>";
echo "<table>";
...
$category_option_data = array(
			  'none'=>'--',
			  'Soil_improve'=>'Soil improve',
              'cure_or_control'=>'cure or control',
