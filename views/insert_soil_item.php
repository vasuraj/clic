...
$selected_soil_section=$this->uri->segment(3);
$selected_soil_item=$this->uri->segment(4);

$name="";
$tname="";
$icon="";

if($selected_soil_item!='' || $selected_soil_item!=null)
{
$selected_soil_info=$this->model_soil->get_soil_item_info($selected_soil_item);


foreach ($selected_soil_info as $value) {
...
echo form_open('soil/store_soil_item/'.$selected_soil_section.'/'.$selected_soil_item,array('class'=>'form','enctype'=>'multipart/form-data'));
echo "<table>";
