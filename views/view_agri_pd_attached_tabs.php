...
echo "<ul id='tiny_nav'>
	...
	<li class='tiny_selected'><a id='basic_information' target='slides' href='".base_url()."index.php/agri/view_slides/".$pd_id."/".$pd_intro_id."/intro/pages'>Basic Information</a></li>
	<li><a id='symptom' target='slides' href='".base_url()."index.php/agri_pd/view_agri_pd_symptom/".$pd_symptom_id."/pages'>Symptom</a></li>
	<li><a id='control' target='slides' href='".base_url()."index.php/agri_pd/view_agri_pd_control/".$pd_npm_id."'>Control</a></li>
</ul>";
