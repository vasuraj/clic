...
$soil_category=$this->uri->segment(3);
$selected_soil=$this->uri->segment(4);
...
echo form_open('soil/store_soil_type/'.$soil_category.'/'.$selected_soil,array('class'=>'form','enctype'=>'multipart/form-data'));
echo "<table>";
