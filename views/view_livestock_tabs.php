...
echo '<li><a data-fancybox-group="gallery"  class="img_gallery"  title="" href="'.base_url().'assets/uploaded/img/'.$slide_image->file_name.'" ><img src="'.base_url().'assets/uploaded/img/thumb_'.$slide_image->file_name.'" /></a></li>';	
}
