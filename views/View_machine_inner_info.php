...
$('#slides').css("height",(screen_size-0));

$( window ).resize(function() {

 var screen_size=$( window ).height();

	$('#slides').css("height",(screen_size-110));
//	$('iframe').css("height",(screen_size-150));
...
echo "<ul id='tiny_nav'>
	...
	<li class='tiny_selected'><a id='basic_information' target='slides' href='".base_url()."index.php/machine/view_machine_specification/".$machine_id."'>Basic Information</a></li>
	<li><a id='symptom' target='slides' href='".base_url()."index.php/machine/view_machine_gallery/".$machine_id."'>Gallery</a></li>
	<li><a id='control' target='slides' href='".base_url()."index.php/machine/view_machine_vendor/".$machine_id."'>vendors</a></li>
</ul>";
...
<div class="row">
	<?php
	echo "<iframe style='margin-left:2%; width:100%; min-height:350px;'name='slides' id='slides' src='".base_url()."assets/blank_iframe_text_pd.html'></iframe>";
	?>
</div>
