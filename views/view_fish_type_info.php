...
echo "<ul id='tiny_nav'>
	...
	<li class='tiny_selected'><a id='basic_information' target='slides' href='".base_url()."index.php/agri/view_slides/".$info[0]->fish_type_id."/".$info[0]->intro."/intro/pages'>Intro</a></li>
	<li ><a id='basic_information' target='slides' href='".base_url()."index.php/agri/view_slides/".$info[0]->fish_type_id."/".$info[0]->feature."/intro/pages'>Feature</a></li>
	<li ><a id='basic_information' target='slides' href='".base_url()."index.php/agri/view_slides/".$info[0]->fish_type_id."/".$info[0]->market_info."/intro/pages'>Market Value</a></li>
