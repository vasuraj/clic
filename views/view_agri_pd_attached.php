...
echo "<a target='_blank' class='slide_add' href='".base_url()."index.php/agri_pd/link_agri_pd_next/fresh/".$this->uri->segment(4)."'>
...
foreach($agri_pd_attched as $agri_pd_attched_record)
{
...
$agri_pd_link_id=$agri_pd_attched_record->agri_pd_link_id;



$agri_id=$agri_pd_attched_record->agri_id;
$category=$agri_pd_attched_record->category;
$pd_id=$agri_pd_attched_record->pd_id;
$pd_symptom_id=$agri_pd_attched_record->pd_symptom_id;
$pd_npm_id=$agri_pd_attched_record->pd_npm_id;


			$agri_pd_info = $this->db->get_where('agri_pd',array('pd_id'=>$pd_id))->result();
			
		//	print_r($agri_pd_info[0]);


foreach ($agri_pd_info as $agri_pd_info_single) {

//print_r($agri_pd_info_single);

$pd_intro_id=$agri_pd_info_single->intro;
...
echo "<a  target='_blank' class='slide_delete' href='".base_url()."index.php/agri_pd/delete_agri_pd_link/".$agri_pd_link_id."/".$encoded_url."'>
...
echo "<a class='popup fancybox fancybox.iframe' href='".base_url()."index.php/agri_pd/view_agri_pd_attached_tabs/".$pd_id."/".$agri_id."/".$category."/".$pd_intro_id."/".$pd_symptom_id."/".$pd_npm_id."'>";
/*
...
//echo $agri_pd_info[0]->name."<br>";
//echo "(".$agri_pd_attched_record->pd_stage.")";
/*

echo "<div id='file_option_area' >";


echo "<a target='_blank' class='slide_add' href='".base_url()."index.php/agri_pd/update_pd_stage/".$agri_pd_attched_record->agri_pd_link_id."'>
<section   id='file_option'><img src='".base_url()."assets/img/file_option/document_edit_2.png'></section></a>";
echo "</div>";
*/
//echo $agri_pd_info[0]->tname;
//echo $agri_pd_info[0]->sname;


/*
echo "<a  class='link_button popup fancybox fancybox.iframe' id='symptom' href='".base_url()."index.php/agri_pd/view_agri_pd_symptom/".$agri_pd_attched_record->pd_symptom_id."/pages'   >
Symptom</a>";

echo "<a class='link_button' id='symptom' target='pd_info' href='".base_url()."index.php/agri_pd/view_agri_pd_symptom/".$agri_pd_attched_record->pd_symptom_id."/pages'>Symptom</a>";
echo "<a  class='link_button' id='npm' target='pd_info' href='".base_url()."index.php/agri_pd/view_agri_pd_control/".$agri_pd_attched_record->pd_npm_id."'>Control</a>";
...
echo "<a target='_blank' id='notification_button' href='".base_url()."index.php/agri_pd/link_agri_pd'>";
