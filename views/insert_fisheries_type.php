...
Insert new section in fisheries 

</div>
<div class="col-xs-12" id='form_input'>
	<?php

$fisheries_category=$this->uri->segment(3);
$selected_fisheries=$this->uri->segment(4);
if($selected_fisheries!='' || $selected_fisheries!=null)
{
$selected_fisheries_info=$this->model_fisheries->get_fisheries($selected_fisheries);


foreach ($selected_fisheries_info as $value) {
	


	 	$this->$fisheries_id =$value->fisheries_id;
...
echo form_open('fisheries/store_fisheries_type/'.$fisheries_category.'/'.$selected_fisheries,array('class'=>'form','enctype'=>'multipart/form-data'));
echo "<table>";
