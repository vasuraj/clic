...
echo "<span id='item_in_list'>$total_item</span>";
		...
		{
			echo "<li class='title'>Pest/ Disease</li>";
		}
		...
		echo "<a class='main_delete'  href='".base_url()."index.php/agri_pd/delete_agri_pd/".$infodata->pd_id."/".$encoded_url."'>
		<section id='file_option'><img src='".base_url()."assets/img/file_option/document_delete.png'></section></a>";
		echo "<br><a  class='main_edit' href='".base_url()."index.php/agri_pd/update_agri_pd/".$infodata->pd_id."/".$encoded_url."'>
...
$tab='intro';
//	echo "<a id='".$column."' target='slides' href='".base_url().'index.php/agri/view_slides/'.$info[0]->pd_id.'/'.$initial_intro_id.'/'.$column."/pages' >".str_replace('_', ' ', $column);
...
// enable this  line below if we have symptoms of pest
   // alert('<?php echo base_url()."index.php/agri/view_slides/".$initial_pd_id."/--/intro/pages"; ?>');
 $('iframe').attr('src','<?php echo base_url()."index.php/agri/view_slides/".$initial_pd_id."/".$initial_intro_id."/intro/pages"; ?>');
...
$('li#main_list a.main_icon').click(function(e){
     ...
     //ajax request hre
//alert("<?php echo base_url(); ?>index.php/agri_pd/get_agri_pd_tabs/"+$(this).attr('href'));
//alert("<?php echo base_url(); ?>index.php/agri_pd/get_agri_pd_tabs/"+$(this).attr('href'));
$.get( "<?php echo base_url(); ?>index.php/agri_pd/get_agri_pd_tabs/"+$(this).attr('href'), function( data ) {
...
//$('#slides').contents().find('body').html('<?php base_url(); ?>index.php/agri/view_slides/10/--/intro/pages');
