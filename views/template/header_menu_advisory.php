...
<li id='climate'><a href="#s1">వాతావరణం</a>
...
<li id='Agriculture'><a href="#s2">పంటలు</a>
...
foreach ($result_agri as $agri_result) {
	...
	echo "<li><a href='".base_url()."index.php/agri/view_agri/crop/".$agri_result->agri_id."'><img id='menu_icon' src='".base_url()."assets/uploaded/img/thumb_".str_replace(' ','_',$agri_result->icon)."'/>".$agri_result->tname."</a></li>";
...
foreach ($result_agri as $agri_result) {
	...
	echo "<li><a href='".base_url()."index.php/agri/view_agri/vegetable/".$agri_result->agri_id."'><img id='menu_icon' src='".base_url()."assets/uploaded/img/thumb_".str_replace(' ','_',$agri_result->icon)."'/>".$agri_result->tname."</a></li>";
...
foreach ($result_agri as $agri_result) {
	...
	echo "<li><a href='".base_url()."index.php/agri/view_agri/fruit/".$agri_result->agri_id."'><img id='menu_icon' src='".base_url()."assets/uploaded/img/thumb_".str_replace(' ','_',$agri_result->icon)."'/>".$agri_result->tname."</a></li>";
...
foreach ($result_agri as $agri_result) {
	...
	echo "<li><a href='".base_url()."index.php/agri/view_agri/millet/".$agri_result->agri_id."'><img id='menu_icon' src='".base_url()."assets/uploaded/img/thumb_".str_replace(' ','_',$agri_result->icon)."'/>".$agri_result->tname."</a></li>";
...
echo "</ul>";
	...
	<li id='livestock' ><a href="#s4">పశు పోషణ</a>
	<ul class="dropdown-menu">
...
foreach ($result_livestock as $livestock_result) {
	...
	echo "<li><a href='".base_url()."index.php/livestock/view_livestock/all/".$livestock_result->livestock_id."'><img id='menu_icon' src='".base_url()."assets/uploaded/img/thumb_".str_replace(' ','_',$livestock_result->icon)."'/>".$livestock_result->tname."</a></li>";
...
foreach ($result_livestock_pd as $livestock_pd_result) {
	...
	echo "<li><a href='".base_url()."index.php/livestock_pd/view_livestock_pd/".$livestock_pd_result->category."/".$livestock_pd_result->pd_id."'><img id='menu_icon' src='".base_url()."assets/uploaded/img/thumb_".str_replace(' ','_',$livestock_pd_result->icon)."'/>".$livestock_pd_result->tname."</a></li>";
...
foreach ($result_pd as $pd_result) {
	...
	echo "<li><a href='".base_url()."index.php/agri_pd/view_agri_pd/pest/".$pd_result->pd_id."'><img id='menu_icon' src='".base_url()."assets/uploaded/img/thumb_".str_replace(' ','_',$pd_result->icon)."'/>".$pd_result->tname."</a></li>";
...
foreach ($result_pd as $pd_result) {
	...
	echo "<li><a href='".base_url()."index.php/agri_pd/view_agri_pd/disease/".$pd_result->pd_id."'><img id='menu_icon' src='".base_url()."assets/uploaded/img/thumb_".str_replace(' ','_',$pd_result->icon)."'/>".$pd_result->tname."</a></li>";
...
foreach ($result_machine as $machine_result) {
	...
	echo "<li><a href='".base_url()."index.php/machine/view_machine_info'><img id='menu_icon' src='".base_url()."assets/uploaded/img/".str_replace(' ','_',$machine_result->icon)."'/>".$machine_result->tname."</a></li>";
...
if(strpos($file_name,'.flv'))
	{
		echo '<li><a data-toggle="tooltip"  title="'.str_replace('.mp4','',(str_replace('.flv','',$file_name))).' movie" id="video-tooltip" href="'.base_url().'assets/movies/'.$category.'/'.$file_name.'"  class="html5lightbox"  >
...
if(strpos($file_name,'.flv'))
	{
		echo '<li><a data-toggle="tooltip"  title="'.str_replace('.mp4','',(str_replace('.flv','',$file_name))).' movie" id="video-tooltip" href="'.base_url().'assets/movies/'.$category.'/'.$sub_category.'/'.$file_name.'"  class="html5lightbox"  >
...
<img src='".base_url()."assets/img/file_option/document_delete.png'</a>
	...
	echo "<a class='popup fancybox fancybox.iframe' href='".base_url()."index.php/agri/view_slides/5qley8ci4l6ir522d9n8/".$soil_sub_section_result->soil_sub_section_id."/soil_info/pages'><img src='".base_url()."assets/uploaded/img/thumb_".$soil_sub_section_result->icon."' alt=''><br>".$soil_sub_section_result->name."</a>";
...
<img src='".base_url()."assets/img/file_option/document_delete.png'</a>
	...
	echo "<a  href='#".$soil_result->section_id."'>";
...
<img src='".base_url()."assets/img/file_option/document_delete.png'</a>
	...
	echo "<a class='popup fancybox fancybox.iframe' href='".base_url()."index.php/agri/view_slides/".$soil_result->section_id."/".$soil_sub_section_result->soil_sub_section_id."/soil_info/pages'><img src='".base_url()."assets/uploaded/img/thumb_".$soil_sub_section_result->icon."' alt=''><br>".$soil_sub_section_result->name."</a>";
...
echo "</ul> ";
	...
	<!-- starting fisheries module -->
	   ...
	   <li><a href="#s7">మంచినీటి చేపల పెంపకం</a>
<?php
echo '<ul class="dropdown-menu">';
...
echo "<li><a class='popup fancybox fancybox.iframe' href='".base_url()."index.php/agri/view_slides/yp7vzmki26yj4f56tx0r/qzo24qijf5nmpaxno7il/value_addition_info/pages'>Value addition</a></li>";
echo "<li><a class='popup fancybox fancybox.iframe' href='".base_url()."index.php/agri/view_slides/yp7vzmki26yj4f56tx0r/qzo24qijf5nmpaxno7il/infrastructure_info/pages'>Infrastructure</a></li>";
echo "<li><a class='popup fancybox fancybox.iframe' href='".base_url()."index.php/agri/view_slides/yp7vzmki26yj4f56tx0r/qzo24qijf5nmpaxno7il/schemes_info/pages'>Govt. schemes</a></li>";
echo "<li><a class='popup fancybox fancybox.iframe' href='".base_url()."index.php/agri/view_slides/yp7vzmki26yj4f56tx0r/qzo24qijf5nmpaxno7il/institution_info/pages'>Institutions</a></li>";
echo "<li><a class='popup fancybox fancybox.iframe' href='".base_url()."index.php/agri/view_slides/yp7vzmki26yj4f56tx0r/qzo24qijf5nmpaxno7il/Economics_info/pages'>Economics</a></li>";
...
foreach ($result_fish_type as $fish_type_result) {
	...
	echo "<li><a class='popup fancybox fancybox.iframe'  href='".base_url()."index.php/fisheries/view_fish_type_info/".$fish_type_result->fish_type_id."'><img id='menu_icon' src='".base_url()."assets/uploaded/img/".str_replace(' ','_',$fish_type_result->icon)."'/>".$fish_type_result->tname."</a></li>";
