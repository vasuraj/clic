...
//print_r($selected_agri_pd_info);
	

	$name=$selected_agri_pd_info[0]->name;
	$tname=$selected_agri_pd_info[0]->tname;
	$sname=$selected_agri_pd_info[0]->sname;
	$final_category=$selected_agri_pd_info[0]->category;
	$icon=$selected_agri_pd_info[0]->icon;
	$static_page_link=$selected_agri_pd_info[0]->static_page_link;
