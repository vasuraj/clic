...
$symptom_to_add=$this->uri->segment(3);
...
{
	$selected_section='pd_symptom_id';
}
...
$sections=array('pd_symptom_id', 'pd_prevention_id', 'pd_treatment_id');
...
{
	echo form_open('agri_pd/store_agri_pd_slides/'.$symptom_to_add.'/'.$selected_id.'/'.$encoded_url,array('class'=>'form', 'enctype'=>'multipart/form-data'));
}
...
{
	echo form_open('livestock_pd/store_livestock_pd_slides/'.$pd_section.'/'.$symptom_to_add.'/'.$selected_id.'/'.$encoded_url,array('class'=>'form', 'enctype'=>'multipart/form-data'));
}
...
echo form_open('livestock_pd/store_livestock_pd_slides/'.$pd_section.'/'.$sections[$key].'/'.$selected_id.'/'.$encoded_url,array('class'=>'form', 'enctype'=>'multipart/form-data'));
