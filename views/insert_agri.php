...
Insert information about Crop/fruit/millet/vegetable
...
echo form_open('agri/store_agri/'.$selected_agri,array('class'=>'form','enctype'=>'multipart/form-data'));
echo "<table>";
