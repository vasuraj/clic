...
echo form_open('weather/store_graph/',array('class'=>'form','enctype'=>'multipart/form-data'));
echo "<table>";
...
echo '<tr><td>';
echo form_label('Upload Graph Image','slide_media_files[]');
echo '</td><td>';
echo '<span class="row">';
...
?>
 ...
 <a id='cancel' href='<?php echo base_url(); ?>' >cancel</a>
<?php
