...
$selected_fisheries_section=$this->uri->segment(3);
$selected_fisheries_item=$this->uri->segment(4);

$name="";
$tname="";
$icon="";

if($selected_fisheries_item!='' || $selected_fisheries_item!=null)
{
$selected_fisheries_info=$this->model_fisheries->get_fisheries_item_info($selected_fisheries_item);
...
echo form_open('fisheries/store_fisheries_item/'.$selected_fisheries_section.'/'.$selected_fisheries_item,array('class'=>'form','enctype'=>'multipart/form-data'));
echo "<table>";
