...
echo '<li><a  class="img_gallery fancybox-button"  data-fancybox-group="gallery"  rel="fancybox-button" href="'.base_url().'assets/uploaded/img/'.$slide_image->file_name.'" ><img src="'.base_url().'assets/uploaded/img/thumb_'.$slide_image->file_name.'" /></a></li>';	
}
...
echo '<li><a data-toggle="tooltip" title="'.$slide_video->file_name.'" id="video-tooltip" href="'.base_url().'assets/uploaded/video/'.$slide_video->file_name.'" " >
