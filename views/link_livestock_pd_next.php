...
if(isset($_POST['livestock_id'][0]))
{

$selected_livestock_id=$_POST['livestock_id'][0];
}

else
{
	$selected_livestock_id=$this->uri->segment(4);
}
...
// echo $selected_pd;
	...
	echo form_open('/livestock_pd/store_link_livestock_pd_next/'.$selected_pd.'/'.$selected_livestock_id,array('class'=>'form','enctype'=>'multipart/form-data'));
echo "<table>";
...
foreach($result_livestock_pd as $livestock_pd_record)
{


echo "<div id='link_box'>
<img  src='".base_url()."assets/uploaded/img/thumb_".$livestock_pd_record->icon."' />

<input type='radio' name='pd_id[]' id='pd_id' value='".$livestock_pd_record->pd_id."'/>";

echo $livestock_pd_record->name.'/ '.$livestock_pd_record->tname;
