...
$this->db->where('npm_id',$info[0]->main_id);
$result_npm=$this->db->get()->result();



echo '<div class="tab_info_no_tabs">
  
<div><img height=50 width=50 src="'.base_url().'assets/uploaded/img/thumb_'.$result_npm[0]->icon.'"/>'.$result_npm[0]->name.'/ '.$result_npm[0]->tname.'</div>
...
echo '<li><a data-fancybox-group="gallery"  rel="fancybox-button" class="img_gallery fancybox-button"  title="" href="'.base_url().'assets/uploaded/img/'.$slide_image->file_name.'" ><img src="'.base_url().'assets/uploaded/img/thumb_'.$slide_image->file_name.'" /></a></li>';  
}
...
echo "<a  class='slide_add' href='".base_url()."index.php/livestock/add_slide_form/".$info[0]->main_id."/".$info[0]->sub_id."/".$info[0]->sub_category."/".base64_encode(base_url().'index.php/livestock/view_slides/'.$info[0]->main_id.'/'.$info[0]->sub_id.'/'.$info[0]->sub_category.'/pages')."'>
