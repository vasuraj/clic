...
if($selected_livestock!='' || $selected_livestock!=null)
{
...
foreach ($selected_livestock_info as $value) {
	 	...
	 	$this->$livestock_id =$value->livestock_id;
        $this->$name =$value->name;
        $this->$tname = $value->tname;
        $this->$category = $value->intro;
        $this->$icon=$value->icon;
        $this->$intro= $values->intro;
        $this->$breeds = $values->breeds;
        $this->$selection = $values->selection;
        $this->$feed = $values->seed_treatment;
        $this->$housing  = $values->housing;
        $this->$feed  = $values->feed;
        $this->$housing  = $values->housing ;
        $this->$reproduction_management  = $values->reproduction_management;
        $this->$calf_rearing  = $values->calf_rearing;
...
echo form_open('livestock/store_livestock/'.$selected_livestock,array('class'=>'form','enctype'=>'multipart/form-data'));
echo "<table>";
