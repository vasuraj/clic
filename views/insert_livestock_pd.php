...
if(!isset($name))
	...
	if(!isset($diseased_livestock))
	{
		$diseased_livestock='';
	}

	if(!isset($final_causative_organism))
	{
		$final_causative_organism='VIRUS';

	}



echo "Livestock Disease Basic Information<br><br>";
...
echo "<tr>";
echo "<td>";
echo form_label('వ్యాది కారక సూక్ష్మ జీవి','causative_organism');
echo "</td>";
echo "<td>";
$causative_organism_data = array(
			  'VIRUS'=>'వైరస్',
              ...
              'PARASITES'=>'పరాన్న జీవి',

                          
              'other'=>'other'
            );

echo form_dropdown('causative_organism',$causative_organism_data,$final_causative_organism);
echo "</td>";
echo "</tr>";
...
echo "<tr>";
echo "<td>";
echo form_label('Diseased livestock: వ్యాదిన పడే జీవాలు','diseased_livestock');
echo "</td>";
echo "<td>";
$diseased_livestock = array(
			  'name'        => 'diseased_livestock',
              'id'          => 'diseased_livestock',
              'value'	=>	$diseased_livestock,
              'class'=> 'validate[required]',
              'size'        => '10',
              'style'       => 'width:400px; text-align:left; padding-left:20px;',
            );
echo form_input($diseased_livestock);
