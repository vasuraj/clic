...
$extra_id_array=array();
            ...
            // $query = $CI_this->db->query('SELECT `agri_id` FROM agri where `agri_id`="'.$key.'" ');

            
            //    $extra_id_array=array();

             $agri_data['agri_id'] =unique_random_string(20,'agri','agri_id',$extra_id_array);
                $agri_data['name'] = $_POST['name'];
                $agri_data['tname'] = $_POST['tname'];
                $agri_data['category'] = $_POST['category'];
                
              $agri_data['intro'] = $extra_id_array[]=unique_random_string(20,'slides','sub_id',$extra_id_array);

                $agri_data['soils'] = $extra_id_array[]=unique_random_string(20,'slides','sub_id',$extra_id_array);
                $agri_data['varieties'] = $extra_id_array[]=unique_random_string(20,'slides','sub_id',$extra_id_array);
                $agri_data['seasonality'] = $extra_id_array[]=unique_random_string(20,'slides','sub_id',$extra_id_array);
                $agri_data['seed_quantity'] = $extra_id_array[]=unique_random_string(20,'slides','sub_id',$extra_id_array);
                $agri_data['seed_treatment'] = $extra_id_array[]=unique_random_string(20,'slides','sub_id',$extra_id_array);
                $agri_data['sowing '] = $extra_id_array[]=unique_random_string(20,'slides','sub_id',$extra_id_array);
                $agri_data['water_management '] = $extra_id_array[]=unique_random_string(20,'slides','sub_id',$extra_id_array);
                $agri_data['weed_management '] = $extra_id_array[]=unique_random_string(20,'slides','sub_id',$extra_id_array);
                $agri_data['nutrient_management '] = $extra_id_array[]=unique_random_string(20,'slides','sub_id',$extra_id_array);
                $agri_data['harvesting '] = $extra_id_array[]=unique_random_string(20,'slides','sub_id',$extra_id_array);
                $agri_data['economics '] = $extra_id_array[]=unique_random_string(20,'slides','sub_id',$extra_id_array);
                $agri_data['recipe '] = $extra_id_array[]=unique_random_string(20,'slides','sub_id',$extra_id_array);
                $agri_data['other_info '] = $extra_id_array[]=unique_random_string(20,'slides','sub_id',$extra_id_array);
               
             

             // echo "<br>-----------final_data------------</br>";  print_r($agri_data);
